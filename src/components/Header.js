...
export const Header = () => {
    return (
        <ViewStyled className="flex flex-row items-center justify-between px-2 py-3 border-solid border-gray-400 border-b-[1px]">
            ...
            <ViewStyled className='flex flex-row items-center'>
              ...
              <ImageStyled source={{ uri: 'https://github.com/RianLimeira.png' }} defaultSource={{ uri: 'https://github.com/RianLimeira.png' }} className={'w-6 h-6 rounded-full'} />
            </ViewStyled>
        </ViewStyled>
    )
}